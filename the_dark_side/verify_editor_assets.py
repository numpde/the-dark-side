...
def verify_frontend_bootstrap_contract() -> None:
    ...
    assert_regex("web/editor-state.mjs", editor_state_js, r'function resolveMatchesForSelector\(')
    assert_regex("web/editor-state.mjs", editor_state_js, r'export function countRoutePolicyChanges\(')
