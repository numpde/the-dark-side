...
def verify_frontend_bootstrap_contract() -> None:
    ...
    assert_regex("web/route-controller.mjs", route_controller_js, r'updateDownloadLinkState\(downloadLink,\s*\{ enabled:')
    ...
    assert_not_contains("web/route-controller.mjs", route_controller_js, 'downloadLink.classList.add("disabled")')
    assert_not_contains("web/route-controller.mjs", route_controller_js, 'downloadLink.classList.remove("disabled")')
    assert_not_contains("web/route-controller.mjs", route_controller_js, 'downloadLink.removeAttribute("href")')
