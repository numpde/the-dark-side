...
def verify_frontend_bootstrap_contract() -> None:
    ...
    assert_regex("web/app.js", app_js, r'requireString\(planner\.network_version,\s*"planner\.network_version"\)')
    ...
    assert_regex("web/app.js", app_js, r'function parseWorkerMessage\(')
    ...
    assert_regex("web/route-worker.js", route_worker_js, r'function parseWorkerRequest\(')
