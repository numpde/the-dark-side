...
def verify_frontend_bootstrap_contract() -> None:
    ...
    assert_regex("web/editor.js", editor_js, r'await import\(`\./editor-asset-runtime\.mjs\$\{moduleSuffix\}`\)')
    assert_regex("web/editor.js", editor_js, r'await import\(`\./editor-map-view\.mjs\$\{moduleSuffix\}`\)')
    assert_regex("web/editor.js", editor_js, r'await import\(`\./editor-shell-view\.mjs\$\{moduleSuffix\}`\)')
    ...
    assert_not_regex("web/editor.js", editor_js, r'function showError\(')
    assert_not_regex("web/editor.js", editor_js, r'function clearError\(')
